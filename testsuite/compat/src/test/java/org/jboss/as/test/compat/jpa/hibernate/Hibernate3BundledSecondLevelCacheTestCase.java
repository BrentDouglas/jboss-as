...
public class Hibernate3BundledSecondLevelCacheTestCase {

    private static final String ARCHIVE_NAME = "Hibernate3BundledSecondLevelCacheTestCase";
    ...
    public static Archive<?> deploy() throws Exception {
        ...
        jar.addClasses(Employee.class, Hibernate3BundledSecondLevelCacheTestCase.class, JndiUtil.class, TestUtil.class);
